...
namespace cp2_enterprise.Controllers
{
    public class VeiculoesController : Controller
    {
        ...
        public VeiculoesController(OracleContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Veiculos != null ? 
                          ...
                          Problem("Entity set 'OracleContext.Veiculos'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Modelo,Placa,Ano,Categoria")] Veiculo veiculo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Modelo,Placa,Ano,Categoria")] Veiculo veiculo)
        {
            if (id != veiculo.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'OracleContext.Veiculos'  is null.");
            }
            var veiculo = await _context.Veiculos.FindAsync(id);
            if (veiculo != null)
            {
